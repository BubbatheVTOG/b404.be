...
public class PersonDB {
    ...
    public List<Person> getAllPeople() throws SQLException {
        ...
        try (PreparedStatement preparedStatement = this.dbConn.conn.prepareStatement(query)) {
            ...
            try (ResultSet result = preparedStatement.executeQuery()) {
                ...
                try (PreparedStatement getCompaniesStatement = this.dbConn.conn.prepareStatement(query)) {
    ...
    public Person getPersonByUsername(final String username) throws SQLException {
        ...
        try (PreparedStatement getAllPeopleStatement = this.dbConn.conn.prepareStatement(query)) {
